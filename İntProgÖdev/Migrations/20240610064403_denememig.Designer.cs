...
namespace İntProgÖdev.Migrations
{
    ...
    [Migration("20240610064403_denememig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("İntProgÖdev.Models.Ders", b =>
                {
            ...
            modelBuilder.Entity("İntProgÖdev.Models.Ogrenci", b =>
                {
            ...
            modelBuilder.Entity("İntProgÖdev.Models.Relationships.OgrenciDers", b =>
                {
                    b.Property<int>("Ogrenciid")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("İntProgÖdev.Models.Relationships.OgrenciDers", b =>
                {
                    b.HasOne("İntProgÖdev.Models.Ders", "Ders")
                        .WithMany("OgrenciDersler")
                        .HasForeignKey("Dersid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("İntProgÖdev.Models.Ogrenci", "Ogrenci")
                        .WithMany("OgrenciDersler")
